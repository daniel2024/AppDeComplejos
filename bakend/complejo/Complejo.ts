...
class Complejo {
    ...
    async potenciaToReal(z1: any, num: any) {
        ...
        aux_resultado = {
            z: await this.polarToRectangular(Number(mod), tita),
            grado: tita * 180
        }
    ...
    async radicacionToReal(z1: any, num: any) {
        ...
        for (let k = 0; k < num; k++) {
            ...
            if (mod == 1) {
                ...
                aux_resultado = {
                    z: await this.polarToRectangular(Number(mod), aux.w),
                ...
                aux_resultado = {
                    z: await this.polarToRectangular(Number(mod), aux),
                    grado: aux * 180,
                    w: 'W' + k + ''
                }
            }
    ...
    async sumaDeFasores(z1: any, z2: any) {
